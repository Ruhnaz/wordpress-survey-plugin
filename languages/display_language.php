    ...
    <h2><a class="button" name="but_submit" href="?page=SMP_Language&action=add" style="background-color: #00CC33; color:#FFFFFF"/>New</a>&nbsp;&nbsp;<!--<input type="button" value="Publish" class="button"/>&nbsp;&nbsp;<input type="button" value="Trash" class="button"/>--></h2>
    <!-- Form -->
    ...
    $date = $dt->format('d-m-Y');
        ...
        <td class="column-columnname"><input type="checkbox" /></td><td class="column-columnname"><a href="#" style="text-decoration:none"><?php echo $row->name; ?></a> <div class="row-actions">
                        <span><a href=?page=SMP_Language&action=edit&id=<?php echo $row->id?>>Edit</a> </span>
                     <!--   <span><a href="#">View</a></span>-->
                    </div></td>
                    <td class="column-columnname"><?php echo $row->shortcode; ?></td>
